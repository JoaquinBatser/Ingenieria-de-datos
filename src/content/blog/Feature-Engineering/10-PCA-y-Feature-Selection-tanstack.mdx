---
title: "PCA o selección de variables"
description: "Comparación de PCA y selección de features sobre Ames Housing: cuánta información se conserva, qué tan explicable queda el modelo y qué pasa con el leakage."
---
import {
  PcaEmbeddingsChart,
  PcaLoadingsChart,
...
**Lectura:** hacen falta 39 componentes para llegar al 80% de varianza. La tabla puede bajar de 81 a 39 columnas y conservar el 80% de la información, una reducción de 51.9%.
...
**Lectura:** t-SNE y UMAP dibujan grupos más claros que PCA en 2D, porque priorizan estructura local. Para modelar, PCA conserva mejor la varianza global.
