---
title: "Medir el sesgo antes de corregirlo"
description: "Dos ejercicios con Fairlearn sobre Boston Housing y Titanic: cómo medir diferencias entre grupos y decidir cuándo una corrección tiene sentido."
---
...
- Dejar criterios para no desplegar un modelo a ciegas.

## Por qué separar los casos
...
### 2. Mirar el sesgo antes del modelo
...
**Lectura:** Las medianas de `MEDV` cambian entre los grupos definidos por la proporción de población afroamericana. El gráfico no prueba por sí solo una causa, pero sí deja claro que el modelo recibiría una señal histórica que no se puede tratar como neutral.
