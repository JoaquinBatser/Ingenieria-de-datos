---
title: "Diagnóstico y tratamiento de datos faltantes"
description: "Evaluación de Ames Housing: mecanismos MCAR, MAR y MNAR, detección de valores atípicos, estrategias de imputación y criterios éticos de trazabilidad."
---
import {
...
# Diagnóstico de datos faltantes en Ames Housing
...
- localizar valores extremos sin eliminarlos antes de verificar su validez;
...
**Interpretación:** El gráfico deja ver qué columnas quedan vacías en las mismas filas. Si una propiedad acumula varios faltantes, la ausencia puede estar ligada a una característica observada; no conviene tratarla como ruido sin comprobarlo.
...
**Interpretación:** IQR y Z-Score no señalan la misma cantidad de filas, sobre todo en `SalePrice` y `Lot Area`. Una propiedad de lujo o un lote grande puede ser extremo y correcto; antes de eliminarlo hay que volver al registro y al contexto.
...
**Interpretación:** La imputación mueve sobre todo las colas de las distribuciones. Comparar forma y varianza antes de seguir evita que un relleno silencioso termine pareciendo un dato real.

<Unit05CorrelationComparison client:load />

**Interpretación:** Las correlaciones se mantienen relativamente estables después de imputar. Es una señal útil, aunque no reemplaza revisar cada variable ni medir el efecto en el modelo.
