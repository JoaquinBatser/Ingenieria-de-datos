---
title: "Análisis geoespacial de CABA con GeoPandas"
description: "Análisis de radios censales de CABA mediante sistemas de referencia, cálculo de áreas y densidad, uniones espaciales, áreas de influencia y cartografía con GeoPandas."
---
...
**Interpretación:** Los radios céntricos concentran mayor densidad; en la periferia las densidades bajan.
...
**Aplicación analítica:** este buffer permite estimar **cobertura de servicios**, **zonas de influencia** y **accesibilidad**.
...
**Interpretación:** La imagen es una captura estática del mapa. La versión HTML permite acercarse y abrir cada marcador; el heatmap resume densidad sin dibujar miles de puntos encima.
