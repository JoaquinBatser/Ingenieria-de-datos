---
title: "Representación y análisis de señales de audio"
description: "Análisis de señales de audio con librosa mediante formas de onda, FFT, espectrogramas, MFCC y un flujo reproducible de clasificación."
---

# Audio como dato: de la señal a las variables predictoras
...
## Representación numérica del audio
...
**Aplicación:** permite identificar formantes de voz, patrones rítmicos y la entrada temporal de instrumentos.
